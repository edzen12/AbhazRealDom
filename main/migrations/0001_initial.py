# Generated by Django 3.2.3 on 2021-05-15 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rs_objects', models.CharField(blank=True, choices=[('1', 'Дома'), ('2', 'Квартиры'), ('3', 'Участки'), ('4', 'Коммерческая недвижимость')], help_text='Например: Дома; Квартиры; Участки; Коммерческая недвижимость', max_length=255, null=True, verbose_name='Объекты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rs_objects', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.rsobjects', verbose_name='Объекты')),
            ],
            options={
                'verbose_name': 'фотка',
