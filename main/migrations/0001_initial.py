# Generated by Django 3.2.3 on 2021-05-21 10:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, max_length=30, null=True, verbose_name='тип недвижимости')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('С ремонтом', 'С ремонтом'), ('Без ремонта', 'Без ремонта ')], max_length=255, null=True, verbose_name='Состояние')),
